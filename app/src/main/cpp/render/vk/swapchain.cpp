...
namespace tire::vk {
    ...
    void Swapchain::createSwapchain() {
        ...
        uint32_t imageCount{};
        {
            ...
            // NOTE: Skip all logic above, just use to two images
        ...
        // NOTE: Skip image count obtained from vkGetSwapchainImagesKHR() above,
        // just use harcodede value.
        swapchainImageCount_ = imageCount;
        ...
        if (const auto err =
            ...
            log::debug(
                    "vk::Swapchain === images acquired, return code is {}!", string_VkResult(err));
        } else {
            throw std::runtime_error(
